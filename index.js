...
const allQBCalcFunctions = require('./dfs_positions_calc_funcs/qbValuesCalcs');
...
// let initialAllWROnesTWRS = [];
// let initialAllWRTwosTWRS = [];

// let allWROnesTWRS = [];
// let allWRTwosTWRS = [];

// // //getting WR projected targets using target share and QB pass attempts from weekly GLSP
...
// //
// //calculating initialAllWROnesTWRS and initialAllWRTwosTWRS
// //
...
//   initialAllWROnesTWRS.push(TWROneS);
//   initialAllWRTwosTWRS.push(TWRTwoS);
// }

// //
// //getting WR projected receptions using projected targets and catchrate
// //
...
//   let newTWRS = initialAllWROnesTWRS[i];
//   newTWRS += WRPrjTargets;
//   36;
//   allWROnesTWRS.push(newTWRS);
// });
...
//   let newWRTwoTWRS = initialAllWRTwosTWRS[i2];

//   newWRTwoTWRS += WRPrjTargets;
//   36;
//   allWRTwosTWRS.push(newWRTwoTWRS);
// });
...
//   WROnesprojectedTargetAndReceptionData: {
...
//   WRTwosprojectedTargetAndReceptionData: {
...
//   TGSAndIPS: {
//     allTeamsTGS: allTGS,
//     allTeamsTotalTeamScoreValueForIPS: IPSArray,
//     allQBIPS: QBIPS,
//     allRBIPS: RBIPS,
