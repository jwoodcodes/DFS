...
const gameFavoredBy = document.querySelector('.vegas__favoredby');
...
const gameInfo = {
  ...
  testQBppps: function (team1, team2) {
    let gameqbPPPs = [team1.QB.ppp, team2.QB.ppp];
...
const [t1QBppp, t2QBppp] = gameInfo.testQBppps(saints, jets);
console.log(t1QBppp, t2QBppp);

const calcAndRenderAll = function (teamOne, teamTwo) {
  const renderVegasGameInfo = function () {
    gameVegas.textContent = `${teamOne.teamName}(${teamOne.projectedPoints}) at ${teamTwo.teamName}(${teamTwo.projectedPoints})`;
...
// const calcRBdata = function () {
//   let gamerbPPPs = [teamOne.RB.ppp, teamTwo.RB.ppp];
//   for (let i = 0; i < gamerbPPPs.length; i++) {
//     if (gamerbPPPs[i] >= 21.7) {
//       gamerbPPPs[i] = 20;
//     } else if (gamerbPPPs[i] > 19.6 && gamerbPPPs[i] < 21.7) {
//       gamerbPPPs[i] = 15;
//     } else if (gamerbPPPs[i] > 18.6 && gamerbPPPs[i] < 19.7) {
//       gamerbPPPs[i] = 10;
//     } else if (gamerbPPPs[i] > 17.6 && gamerbPPPs[i] < 18.7) {
//       gamerbPPPs[i] = 5;
//     } else if (gamerbPPPs[i] > 16.6 && gamerbPPPs[i] < 17.7) {
//       gamerbPPPs[i] = 0;
//     } else if (gamerbPPPs[i] > 14.6 && gamerbPPPs[i] < 16.7) {
//       gamerbPPPs[i] = -5;
//     } else {
//       gamerbPPPs[i] = -10;
//     }

//     let t1rbPPP = gameqbPPPs[0];
//     let t2rbPPP = gameqbPPPs[1];
//     // console.log(t1qbPPP);
//     // console.log(t2qbPPP);
...
//     const renderrbdata = function () {
//       rbPPP.textContent = `PPP: ${teamOne.RB.rbName}: ${t1rbPPP}, ${teamTwo.RB.rbName}: ${t2rbPPP}`;

//       rbTotalScoreItem.textContent = `Total RB score(def + PPP): ${teamOne.RB.rbName}: ${t1GameScore}, ${teamTwo.RB.qbName}: ${t2RBGameScore}`;
