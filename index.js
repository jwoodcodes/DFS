...
const getData = function (teamOne, teamTwo) {
  ...
  const getQBPPP = function (ppp1, ppp2) {
    let t1qbPPP = teamOne.QB.ppp;
    let t2qbPPP = teamTwo.QB.ppp;
    if (t1qbPPP >= 21.7) {
      t1qbPPP = 20;
    } else if (t1qbPPP > 19.6 && t1qbPPP < 21.7) {
      t1qbPPP = 15;
    } else if (t1qbPPP > 18.6 && t1qbPPP < 19.7) {
      t1qbPPP = 10;
    } else if (t1qbPPP > 17.6 && t1qbPPP < 18.7) {
      t1qbPPP = 5;
    } else if (t1qbPPP > 16.6 && t1qbPPP < 17.7) {
      t1qbPPP = 0;
    } else if (t1qbPPP > 14.6 && t1qbPPP < 16.7) {
      t1qbPPP = -5;
    } else {
      t1qbPPP = -10;
    }
    ...
    if (t2qbPPP >= 21.7) {
      t2qbPPP = 20;
    } else if (t2qbPPP > 19.6 && t2qbPPP < 21.7) {
      t2qbPPP = 15;
    } else if (t2qbPPP > 18.6 && t2qbPPP < 19.7) {
      t2qbPPP = 10;
    } else if (t2qbPPP > 17.6 && t2qbPPP < 18.7) {
      t2qbPPP = 5;
    } else if (t2qbPPP > 16.6 && t2qbPPP < 17.7) {
      t2qbPPP = 0;
    } else if (t2qbPPP > 14.6 && t2qbPPP < 16.7) {
      t2qbPPP = -5;
    } else {
      t2qbPPP = -10;
    }
