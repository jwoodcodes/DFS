  ...
  function (
    ...
    if (percentValueDiffBetweenMyValueAndMarket >= 0) {
      ...
      if (myRedraftDifferenceScore < 0) {
        ...
        if (Math.abs(myRedraftDifferenceScore) === 700) {
          let value =
            fantasyCalcValue - (fantasyCalcValue * 0.275) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        ...
        if (Math.abs(myRedraftDifferenceScore) === 500) {
          let value =
            fantasyCalcValue - (fantasyCalcValue * 0.16) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        ...
        if (Math.abs(myRedraftDifferenceScore) === 400) {
          let value =
            fantasyCalcValue - (fantasyCalcValue * 0.12) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        ...
        if (Math.abs(myRedraftDifferenceScore) === 200) {
          let value =
            fantasyCalcValue - (fantasyCalcValue * 0.05) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        if (Math.abs(myRedraftDifferenceScore) === 100) {
          let value =
            fantasyCalcValue - (fantasyCalcValue * 0.04) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        if (Math.abs(myRedraftDifferenceScore) === 0) {
          let value =
            fantasyCalcValue - (fantasyCalcValue * 0.03) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
    ...
    if (percentValueDiffBetweenMyValueAndMarket < 0) {
      ...
      if (myRedraftDifferenceScore >= 0) {
        ...
        if (myRedraftDifferenceScore === 700) {
          let value =
            fantasyCalcValue + (fantasyCalcValue * 0.15) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        if (myRedraftDifferenceScore === 600) {
          // console.log(name, value);
          let value =
            fantasyCalcValue + (fantasyCalcValue * 0.1) / fcQBMaxValue;
          if (value) {
            // console.log(name, value);
            return value;
          }
        ...
        if (myRedraftDifferenceScore === 500) {
          let value =
            fantasyCalcValue + (fantasyCalcValue * 0.08) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
        if (myRedraftDifferenceScore === 400) {
          let value =
            fantasyCalcValue + (fantasyCalcValue * 0.07) / fcQBMaxValue;
          if (value) {
            return value;
          }
        }
