...
const rbPastAgeApexButWithinTwoYearsButWillBeInWorseBucketNextMarch = function (
  curMonth,
  name,
  fantasyCalcValue,
  ...
  if (percentValueDiffBetweenMyValueAndMarket < 0) {
    ...
    if (myRedraftDifferenceScore >= 0) {
      ...
      if (myRedraftDifferenceScore === 400) {
        let value =
          fantasyCalcValue + (fantasyCalcValue * 0.055) / fcNonQBMaxValue;
        if (value) {
          return value;
        }
      }
...
module.exports = rbPastAgeApexButWithinTwoYearsButWillBeInWorseBucketNextMarch;
